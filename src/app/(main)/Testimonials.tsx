...
const CommunityTestimonials = () => {
    ...
    return (
        <section className="min-h-[80vh] py-20 overflow-hidden font-sans text-white border border-red-500">
      ...
      `}</style>
            ...
            <div className="flex flex-col justify-center items-center gap-20">
                ...
                <div className="relative w-full group border border-red-500">
