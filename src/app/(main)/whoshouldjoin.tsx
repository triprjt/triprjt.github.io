...
const WhoShouldJoin = () => {
    ...
    return (
        <section className=" w-full py-20 text-white relative overflow-hidden mx-auto flex justify-center items-center border border-red-500">
            ...
            <div className="max-w-7xl mx-auto px-6 flex flex-col items-center gap-12 border border-red-500">
                {/* Section Header */}
