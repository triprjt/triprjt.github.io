...
const Offer = ({ onClose }: { onClose: () => void }) => {
    ...
    return (
        <div className="relative flex flex-col md:flex-row justify-center items-center gap-3 md:gap-2 border border-yellow-500">
            <span className="text-white text-sm text-center w-[80%] md:w-full md:text-xl font-medium uppercase border border-yellow-500">{message}</span>
            <div className="flex flex-row w-[80%] md:w-full items-center justify-center gap-3">
            ...
            <div
                className="absolute top-[-10] right-[-10] md:relative md:top-auto md:right-auto border border-black rounded-full p-2 cursor-pointer"
